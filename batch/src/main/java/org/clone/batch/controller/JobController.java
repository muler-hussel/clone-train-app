package org.clone.batch.controller;

import org.clone.batch.req.CronJobReq;
import org.clone.batch.resp.CronJobResp;
...
public class JobController {
    ...
    public CommonResponse<Object> run(@RequestBody CronJobReq cronJobReq) throws SchedulerException {
    ...
    public CommonResponse add(@RequestBody CronJobReq cronJobReq) {
        String jobClassName = cronJobReq.getName();
        String jobGroupName = cronJobReq.getGroup();
    ...
    public CommonResponse pause(@RequestBody CronJobReq cronJobReq) {
        String jobClassName = cronJobReq.getName();
        String jobGroupName = cronJobReq.getGroup();
    ...
    public CommonResponse resume(@RequestBody CronJobReq cronJobReq) {
        String jobClassName = cronJobReq.getName();
        String jobGroupName = cronJobReq.getGroup();
    ...
    public CommonResponse reschedule(@RequestBody CronJobReq cronJobReq) {
        String jobClassName = cronJobReq.getName();
        String jobGroupName = cronJobReq.getGroup();
        String cronExpression = cronJobReq.getCronExpression();
        String description = cronJobReq.getDescription();
    ...
    public CommonResponse delete(@RequestBody CronJobReq cronJobReq) {
        String jobClassName = cronJobReq.getName();
        String jobGroupName = cronJobReq.getGroup();
