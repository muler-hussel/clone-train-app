package org.clone.common.aspect;
...
public class LogAspect {
     ...
     * 定义一个切点
     */
    @Pointcut("execution(public * org.clone..*Controller.*(..))") //所有返回值，clone下所有项目的所有controller后缀文件中任意方法任意参数
    ...
    public Object doAround(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        LOG.info("------------- END Cost time：{} ms -------------", System.currentTimeMillis() - startTime);
        return result;
    }
